...
public class LeerlingTest {
	...
	private Leerling leerling, zelfdeleerling, tweedeleerling, derdeleerling,
			vierdeleerling;
	...
	/**
	 * Test of twee leerlingen met dezelfde via de constructor ingegeven parameters ook 
	 * effectief dezelfde waardes hebben voor hun fields
	 */
	
	@Test
	public void testLeerling_VoornaamFamilieNaamEnLeerjaar_LeerlingIsDezelfde() {
		assertEquals("Voornaam gelijk", leerling.getLeerlingVoornaam(),
				zelfdeleerling.getLeerlingVoornaam());
		assertEquals("Familienaam gelijk", leerling.getLeerlingFamilienaam(),
				zelfdeleerling.getLeerlingFamilienaam());
		assertEquals("Leerjaar gelijk", leerling.getLeerjaar(),
				zelfdeleerling.getLeerjaar());
	}
	...
	public void testSetLeerjaar_GeldigJaar_ZetJuisteLeerjaar() {
		...
		assertEquals("Familienaam gelijk", "Vandamme",
				leerling.getLeerlingFamilienaam());
	...
	public void testSetLeerlingFamilienaam_Familienaam_ZetJuisteFamilienaam() {
		...
		assertEquals("Voornaam gelijk", "Marie", leerling.getLeerlingVoornaam());
		assertEquals("Familienaam gelijk", "Vogels",
				leerling.getLeerlingFamilienaam());
		assertEquals("Leerjaar gelijk", 3, leerling.getLeerjaar());
	}

	/**
	 * Test of een familienaam met spaties ervoor zonder fouten aangepast 
	 * kan worden via setFamilienaam
	 */
	...
	/*
	 * @Test public void
	 * testAddQuizDeelname_QuizDeelname_QuizDeelnameIsToegevoegd(){
	 * leerling.addQuizDeelname(quizdeelname);
	 * assertTrue("Quizdeelname toegevoegd", ) }
	 */
	...
	public void testCompareTo_TweeLeerlingenMetZelfdeFamilieNaam_FamilieNaamIsZelfde() {
		assertTrue("Leerlingen met zelfde familienaam",
				leerling.compareTo(tweedeleerling) == 0);
	}
	...
	public void testCompareTo_TweeLeerlingenMetVerschillendeFamilieNaam_GeeftFalse() {
		assertFalse("Leerlingen met verschillende familienaam",
				leerling.compareTo(derdeleerling) == 0);
	}
	
	/**
	 * Test de CompareTo method voor 2 leerlingen met dezelfde familienaam 
	 * met verschillende hoofdletters
	 */

	@Test
	public void testCompareTo_TweeLeerlingenMetZelfdeFamilieNaamCases_FamilieNaamIsZelfde() {
		assertTrue("Leerlingen met zelfde familienaam",
				derdeleerling.compareTo(vierdeleerling) == 0);
	}
	...
	/*@Test
	public void testClone_Leerling_IsDezelfde(){
		Leerling gekloond = vierdeleerling.clone();
