...
public class ViewFactory {
	...
	public IView maakView(ViewType type) {
		...
		case OverzichtScoresQuizzen:
			if (settings.getProperty("overzichtscoresquizzen").equals("OverzichtScoresQuizzenView")) {
				return new OverzichtScoresQuizzenView();
			}
			break;
		case OverzichtScoresLeerlingen:
			if (settings.getProperty("overzichtscoresleerlingen").equals("OverzichtScoresLeerlingenView")) {
				return new OverzichtScoresLeerlingenView();
			}
			break;
		case OverzichtScoresAntwoorden:
			if (settings.getProperty("overzichtscoresantwoorden").equals("OverzichtScoresAntwoordenView")) {
