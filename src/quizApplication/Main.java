...
public class Main {
	...
	public static void main(String[] args) {	
		...
		LeerlingContainer leerlingContainer;
		QuizCatalogus quizCatalogus;
		OpdrachtCatalogus opdrachtCatalogus;
		
		Leerling Ben, Bert, Adriaan, Jef, Johan;
		Opdracht klassiek, opsomming, meerkeuze, reproductie;
		Quiz quizA, quizB;
		...
		txtDb.schrijfQuizDeelnames(leerlingContainer.getAlleQuizDeelnames());
	}
}
