...
public class QuizScoresRapportController {
	...
	public QuizScoresRapportController(DBHandler dbHandler, Leerling leerling,
		...
		QuizDeelnameTableModel tableModel =new QuizDeelnameTableModel(leerling
				.getQuizDeelnames()); 
		View.setTableModel(tableModel);
		//View.setTableModel1(new QuizDeelnameQuizScoresTableModel(leerling.getAlleOpdrachtAntwoorden()));
		View.setVisible(true);
		View.addSelectionListener(new QuizDeelnameSelectionListener(View, leerling, tableModel));
	}
...
class QuizDeelnameSelectionListener implements ListSelectionListener {
	...
	public QuizDeelnameSelectionListener(IQuizScoresRapportView view, Leerling leerling, QuizDeelnameTableModel model) {
		super();
		this.leerling = leerling;
		this.View=view;
		this.model=model;
...
class QuizDeelnameTableModel extends AbstractTableModel {
	...
	public QuizDeelnameTableModel(Collection<QuizDeelname> deelnames) {
		...
		this.deelnamenVanLeerling = new ArrayList<QuizDeelname>(
				deelnames);

		headersDeelnames = new String[] { "Quiz", "Datum deelname", "Behaalde Score"};
	}
...
class QuizDeelnameQuizScoresTableModel extends AbstractTableModel {
	...
	public QuizDeelnameQuizScoresTableModel(ArrayList<OpdrachtAntwoord> antwoorden) {
		super();

		headersQuizScores = new String[] { "Opdrachtvraag", "Juiste antwoord",
				"Laatste antwoord", "Behaalde Score" };
